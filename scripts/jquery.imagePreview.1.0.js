	...
	$.fn.preview = function(){
		...
		$(this).each(function(){
			$(this).hover(function(e){
				if(/.png$|.gif$|.jpg$|.bmp|.jpeg$/.test($(this).attr("href"))){
					$("body").append("<div id='preview'><div><img src='"+$(this).attr('href')+"' referrerPolicy=\"no-referrer\"/><p>"+$(this).attr('title')+"</p></div></div>");
				}else{
